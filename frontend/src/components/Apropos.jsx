  ...
  return (
    <div className="apropos">
      <div className="title-description">
        ...
        <div className="description-contenaire">
          <p className="firstparagraph">
            Bienvenue sur BotySense, votre destination de choix pour tout ce qui
            concerne l'univers captivant de la beauté et de la cosmétique signée
            Oreal. Chez BotySense, nous sommes déterminés à vous découvrir votre
            propre sens de la beauté et de l'élégance, tout en mettant à votre
            disposition une gamme exclusive de produits de qualité supérieure.
            <br />
